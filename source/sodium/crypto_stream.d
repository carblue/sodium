...
//  immutable(char*) crypto_stream_PRIMITIVE = "xsalsa20";
  ...
  int crypto_stream(ubyte* c, in ulong clen, in ubyte* n, in ubyte* k) @system;
  int crypto_stream_xor(ubyte* ciphertext, in ubyte* message, in ulong messagelen, in ubyte* nonce, in ubyte* key) @system;
}
...
/** overload */
int crypto_stream_xor(ubyte[] ciphertext, in ubyte[] message, in ubyte[crypto_stream_NONCEBYTES] nonce, in ubyte[crypto_stream_KEYBYTES] key) pure @trusted
{
