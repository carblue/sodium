...
extern(C) pure @nogc
{
  ...
  int crypto_pwhash_argon2i(const(ubyte*) out_, ulong outlen, const(char*) passwd, ulong passwdlen, const(ubyte*) salt, ulong opslimit, size_t memlimit, int alg) nothrow @system;
  int crypto_pwhash_argon2i_str(ref char[crypto_pwhash_argon2i_STRBYTES] out_, const(char*) passwd, ulong passwdlen, ulong opslimit, size_t memlimit) nothrow @system;
  int crypto_pwhash_argon2i_str_verify(ref const(char)[crypto_pwhash_argon2i_STRBYTES] str, const(char*) passwd, ulong passwdlen) nothrow @system;
