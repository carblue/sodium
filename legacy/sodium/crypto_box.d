...
import sodium.crypto_box_curve25519xsalsa20poly1305 : crypto_box_curve25519xsalsa20poly1305_SEEDBYTES,
...
int crypto_box_easy(ubyte* c, const(ubyte)* m,
                    ...
                    const(ubyte)* pk, const(ubyte)* sk) nothrow @system; // __attribute__ ((warn_unused_result));
...
size_t  crypto_box_beforenmbytes() @trusted;
...
size_t crypto_box_sealbytes() @trusted;

int crypto_box_seal(ubyte* c, const(ubyte)* m,
                    ulong mlen, const(ubyte)* pk) @system;
