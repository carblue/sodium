...
int crypto_kx_seed_keypair(ref ubyte[crypto_kx_PUBLICKEYBYTES] pk,
                           ...
                           ref const(ubyte)[crypto_kx_SEEDBYTES] seed) pure;

int crypto_kx_keypair(ref ubyte[crypto_kx_PUBLICKEYBYTES] pk,
                      ref ubyte[crypto_kx_SECRETKEYBYTES] sk) nothrow;
...
int crypto_kx_client_session_keys(ref ubyte[crypto_kx_SESSIONKEYBYTES] rx,
                                  ...
                                  ref const(ubyte)[crypto_kx_PUBLICKEYBYTES] server_pk) pure nothrow; //  __attribute__ ((warn_unused_result));
...
int crypto_kx_server_session_keys(ref ubyte[crypto_kx_SESSIONKEYBYTES] rx,
                                  ...
                                  ref const(ubyte)[crypto_kx_PUBLICKEYBYTES] client_pk) pure nothrow; //  __attribute__ ((warn_unused_result));
